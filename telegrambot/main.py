...
bot = telebot.TeleBot('5031695049:AAHk1xX8TY7ZbBvP2lxvUVW_errMrvlmdH4')

conn = psycopg2.connect(database="pyatlab", user="postgres", password="1a3c5e7", host="localhost", port="5432")
cursor = conn.cursor()
